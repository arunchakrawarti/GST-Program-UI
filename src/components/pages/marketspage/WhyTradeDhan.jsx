...
//     icon: <FiBarChart2 />,
//     title: "Low Brokerage",
//     desc: "Trade with flat ₹20 orders and zero hidden charges.",
//   },
//   {
//     icon: <FiTrendingUp />,
//     title: "Powerful Platforms",
//     desc: "Dhan Web, App, and TradingView integration for all users.",
//   },
//   {
//     icon: <FiShield />,
//     title: "Safe & Secure",
//     desc: "100% SEBI regulated platform with advanced data protection.",
//   },
// ];
...
//           Why Trade with DhanTrade?
//         </h2>
//         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-6 md:gap-7 lg:gap-8">
//           {reasons.map((r, i) => (
//             <div key={i} className="p-8 bg-[#f9f9f9] rounded-2xl border border-gray-medium/10 hover:border-none hover:shadow-md transition-all">
//               <div className="text-amber text-4xl mb-4 flex justify-center">{r.icon}</div>
