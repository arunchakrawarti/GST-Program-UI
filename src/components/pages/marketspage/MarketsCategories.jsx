...
// const categories = [
//   { title: "Stocks", desc: "Track NSE & BSE equity markets live." },
//   { title: "Futures & Options", desc: "View index & stock derivatives data." },
//   { title: "Commodities", desc: "MCX Gold, Silver, Crude & more." },
//   { title: "ETFs", desc: "Diversify with top exchange-traded funds." },
// ];

// const MarketsCategories = () => {
//   return (
